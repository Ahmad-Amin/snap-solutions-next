                    ...
                    <div className="row">
                        <div className="col-lg-8 col-md-12">
                            <div className="terms-of-condition-content">
                                ...
                                <h3>Welcome to Snap Credit Solutions Privacy Policy</h3>
                                <p>
This Privacy Policy discloses the privacy practices for www.snapcreditsolutions.com and applies solely to information collected through this website (Site).</p>

<p>We reserve the right to change this Privacy Policy from time to time. The Privacy Policy is subject to and incorporates by reference our Terms of Use, including its limitation on liability.</p>

<p>Your use of our Site and submission of Personal Information online constitutes acceptance and understanding of this Policy as in effect at the time of your submission.</p>

<p>TYPES OF PERSONAL INFORMATION WE COLLECT: 
We do not collect Personal Information from visitors to our Site unless you voluntarily decide to transmit it to us through one of the Site features, provided e-mail addresses or as part of an application. Certain features of our Site may require you to create an account. When you create an account with us, we may collect your name, email address, contact information, a username and password that you will use to access your account and other information. In addition, to submit a question, comment, or post to a blog, you may be required to submit your name and email address, and we may also ask you for other optional information, such as your business’s website address.We also collect the following types of information (Personal or otherwise) through the Site:Information submitted on an application;
Information to verify an individual’s identity (e.g., social security number, an unexpired government identification with a photo, user name and password, etc.);
...
Individual and business financial or credit bureau information;
Personal Information contained in government filings or legal agreements (e.g., corporate formation agreements, business licenses, lease or loan agreements, and business tax returns);
Any other Personal Information you submit or upload through our Site or to one of our email addresses, including information you post to our Site in a comment, blog or testimonial;
...
Your or your business’s geolocation, through various GPS or other geolocator tools that use the IP address of your device to detect a user’s location; and
Information collected through our Site data or through an ISO (independent sales organization), or other data that we receive from other sources, such as public records, and other background information supplied by information services or third parties.
WHAT WE DO WITH THE PERSONAL INFORMATION COLLECTED.</p>

<p>We will use the information you provide us in those communications to evaluate your business’s eligibility for products provided through Snap Credit solutions, respond to your inquiries, and to provide you with information relating to our company or services that we believe you may find of interest. We may also use that information to market products or services to you.We may disclose Personal Information to third parties for the following purposes:In response to a subpoena or other legal process by a governmental entity or third party, or if otherwise required by law;
To protect or enforce our rights or property;
In the event of the sale or dissolution (bankruptcy) of all of our assets, in which case, you will be notified thereafter by a prominent notice on our Web site of any change in ownership or uses of your personal information, as well as any choices you may have regarding your personal information;
...
To our affiliates, subsidiaries and other third parties for marketing, advertising, research or other business purposes;
...
To provide information or promotional material that may be of interest to you*;
To our investors, partners**, or auditors in the course of their review or auditing us;
To provide products or services requested; and
...
‍
<p>COOKIES AND THIRD-PARTY ANALYTICS: 
...
<p>INFORMATION POSTED TO OUR SITE: We may, from time to time, allow users to post information to our Site, such as comments or testimonials. Any information that you post to our Site becomes public information and may be viewable by other users, as well as visitors to our Site (this is not true of uploaded documents as part of the funding process). In addition, your name, as well as other optional information you choose to submit along with the information you post, will be publicly displayed. We are not responsible for the privacy of any information that you choose to post to our Site, or for the accuracy of any information contained in those postings. We cannot prevent such information from being used by others in a manner that may violate this Privacy Policy, the law, or your personal privacy. Your posting of any content to any of the Site is subject to our Terms of Use.</p>

<p>THIRD-PARTY LINKS: At times, our Site may contain links to other, third-party websites. Any access to and use of such linked websites is not governed by this Privacy Policy but, instead, is governed by the privacy policies of those third-party websites. We are not responsible for the information practices of such third-party websites.</p>

<p>INTERNATIONAL USERS: The Site is hosted in the United States. If you are accessing the Site from outside the United States, by providing your information to the Site, you are consenting to and authorizing the transfer of your information to the United States for storage, use, processing, maintenance, and onward transfer of such information to other entities regardless of their location in accordance with this Privacy Policy and our Terms of Use. You are also consenting to the application of United States law in all matters concerning the Site.</p>

<p>SESSION TIME-OUTS: We also employ session time-outs to protect your account. You will be logged out of the Site automatically after a specified period of inactivity. This time-out feature reduces the risk of others being able to access your account if you leave your computer unattended.</p>

<p>WHAT YOU CAN DO TO PROTECT YOUR PERSONAL INFORMATION: In addition to our own efforts, you can take several precautions to protect the security of your computer and Personal Information. For instance, you should create and use a complex password, using numbers, a combination of small and large capital letters, and special characters. You should avoid using any information that others can easily learn about you, such as your mother’s maiden name, a family member’s name or birthday. We also recommend that you change your password frequently. You should never share your password with anyone, or leave it written down in an unsecure area.You can also install and regularly update antivirus and firewall software to protect your computer or device from external attacks by malicious users. If you use a computer that can be accessed in a public area (e.g., library, coffee shop, etc.), we recommend that you take special precautions to protect the security of your account and Personal Information. When you are finished visiting our Site, you should log out completely, close the browser window and clear the browser’s cache files.You should also be aware of fraudulent attempts to gain access to your account information known as “phishing.” Phishing is a tactic used by scammers to lure people to a phony website through the use of a genuine-looking email purporting to be from a legitimate company. Either in the email itself or on this fake website site, scammers will ask for login information to gain access to people’s accounts and withdraw their money. Snap Credit Solutionswill never ask you for your login information in the context of any email. In general, you can protect yourself against phishing by never providing login or Personal Information via an email. You should always ensure the Snap Credit Solutions URL that you are provided begins with: https://www.snapcreditsolutions.com or https://www.snapcreditsolutions.com.</p>
...
<p>CONTACT US: You may use the following information to contact us with any questions or concerns about this Privacy Policy:</p>
sales@snapcreditsolutions.com
                            </div>
                        </div>
