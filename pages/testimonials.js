                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="clients-item">
                                ...
                                <p>I've had nothing but positive experiences with this company. Their dedication to simplifying small business funding is truly remarkable, and it shows in every aspect of their service. The application process was quick and easy, and I was impressed with how tailored their options were to my specific needs.</p>
                                <div className="icon">
