                ...
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item">
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li className="nav-item">
                        <Link href="/affiliates" activeClassName="active">
                          <a onClick={toggleNavbar} className="nav-link">
                            Affiliates
                          </a>
                        </Link>
                  ...
                  <li className="nav-item">
                    <Link href="/sign-in" activeClassName="active">
                      <a onClick={toggleNavbar} className="nav-link login-link">
                      <svg xmlns="http://www.w3.org/2000/svg" width="35" height="20" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                ...
                <div className="others-options d-flex align-items-center">
                  ...
                  {/* <div className="option-item">
                    <div className="info">
                      ...
                      <span>Call Now</span>
                      <p>
                        <a href="mailto:snap">917-277-5545</a>
                      </p>
                    </div>
                  </div> */}
