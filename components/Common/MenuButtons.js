...
const MenuButtons = ({ icon, menuText, isEnabled, link, setShowSideBar }) => {
  return (
    <>
      {isEnabled ? (
        <Link className=" tw-cursor-pointer " href={link}>
          <button
            ...
            className="tw-bg-transparent tw-p-0 tw-flex tw-justify-center tw-items-center tw-gap-6 tw-py-4 tw-text-neutral-500 hover:tw-text-red-500 tw-transition tw-ease-in-out "
          >
